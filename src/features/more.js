      ...
      el(
        ...
        el(
          ...
          el(
            ...
            el(
              'div',
              { class: 'more-tools__links' },
              el(
                'button',
                { type: 'button', class: 'more-tools__settings', onClick: () => go('/settings') },
                icon('settings', 'w-5 h-5'),
                el('span', null, el('strong', null, 'App settings'), el('small', null, 'Theme, feedback, and data')),
                icon('next', 'ml-auto w-4 h-4'),
              ),
              el(
                'button',
                { type: 'button', class: 'more-tools__settings', onClick: () => go('/privacy') },
                icon('shield', 'w-5 h-5'),
                el('span', null, el('strong', null, 'Privacy'), el('small', null, 'What happens to your data')),
                icon('next', 'ml-auto w-4 h-4'),
              ),
            ),
          ),
